...
const SecondaryButton = ({ children, onClick, disabled = false }) => {
    ...
    return React__default["default"].createElement(
        "button",
        { type: "button", className: getClassName(), onClick: onClick, disabled: disabled },
        children
    );
};
...
const Days = ({ calendarData, onClickPreviousDays, onClickDay, onClickNextDays }) => {
    ...
    // Functions
    const currentDateClass = React.useCallback(
        item => {
            const itemDate = `${calendarData.date.year()}-${calendarData.date.month() + 1}-${
                item >= 10 ? item : "0" + item
            }`;
            if (
                formatDate(require$$0__default["default"]()) ===
                formatDate(require$$0__default["default"](itemDate))
            )
    ...
    const activeDateData = React.useCallback(
        day => {
            const fullDay = `${calendarData.date.year()}-${calendarData.date.month() + 1}-${day}`;
            let className = "";
            if (
                require$$0__default["default"](fullDay).isSame(period.start) &&
                require$$0__default["default"](fullDay).isSame(period.end)
            ) {
                ...
                className = ` ${BG_COLOR["500"][primaryColor]} text-white font-medium ${
                    require$$0__default["default"](fullDay).isSame(dayHover) && !period.end
                        ? "rounded-full"
                        : "rounded-l-full"
                }`;
            } else if (require$$0__default["default"](fullDay).isSame(period.end)) {
                className = ` ${BG_COLOR["500"][primaryColor]} text-white font-medium ${
                    require$$0__default["default"](fullDay).isSame(dayHover) && !period.start
                        ? "rounded-full"
                        : "rounded-r-full"
                }`;
            }
    ...
    const hoverClassByDay = React.useCallback(
        day => {
            ...
            if (period.start && period.end) {
                if (
                    require$$0__default["default"](fullDay).isBetween(
                        period.start,
                        period.end,
                        "day",
                        "[)"
            ...
            if (
                period.end &&
                require$$0__default["default"](fullDay).isBetween(dayHover, period.end, "day", "[)")
            ) {
                className = ` ${BG_COLOR["100"][primaryColor]} ${currentDateClass(
                    day
                )} dark:bg-white/10`;
    ...
    const isDateTooEarly = React.useCallback(
        (day, type) => {
            if (!minDate) {
                return false;
            }
            ...
            return require$$0__default["default"](formattedDate).isSame(
                require$$0__default["default"](minDate),
                "day"
            )
                ? false
                : require$$0__default["default"](formattedDate).isBefore(
                      require$$0__default["default"](minDate)
                  );
        },
        [calendarData.date, minDate]
    );
    const isDateTooLate = React.useCallback(
        (day, type) => {
            if (!maxDate) {
                return false;
            }
            ...
            return require$$0__default["default"](formattedDate).isSame(
                ...
                ? false
                : require$$0__default["default"](formattedDate).isAfter(
                      require$$0__default["default"](maxDate)
                  );
        },
    ...
    const isDateDisabled = React.useCallback(
        (day, type) => {
            ...
            disabledDates?.forEach(dateRange => {
                if (
                    require$$0__default["default"](formattedDate).isAfter(dateRange.startDate) &&
                    require$$0__default["default"](formattedDate).isBefore(dateRange.endDate)
                ) {
                    matchingCount++;
                }
                if (
                    require$$0__default["default"](formattedDate).isSame(dateRange.startDate) ||
    ...
    const buttonClass = React.useCallback(
        (day, type) => {
    ...
    const checkIfHoverPeriodContainsDisabledPeriod = React.useCallback(
        hoverPeriod => {
            ...
            for (let i = 0; i < disabledDates.length; i++) {
                if (
                    require$$0__default["default"](hoverPeriod.start).isBefore(
                        disabledDates[i].startDate
                    ) &&
                    require$$0__default["default"](hoverPeriod.end).isAfter(
                        disabledDates[i].endDate
                    )
                ) {
                    return true;
                }
    ...
    const hoverDay = React.useCallback(
        (day, type) => {
            ...
            if (period.start && !period.end) {
                ...
                if (
                    require$$0__default["default"](newHover).isBefore(
                        require$$0__default["default"](period.start)
                    )
                ) {
            ...
            if (!period.start && period.end) {
                ...
                if (
                    require$$0__default["default"](newHover).isAfter(
                        require$$0__default["default"](period.end)
                    )
                ) {
    ...
    const handleClickDay = React.useCallback(
        (day, type) => {
...
const Months = ({ currentMonth, clickMonth }) => {
    ...
    return React__default["default"].createElement(
        "div",
        { className: "w-full grid grid-cols-2 gap-2 mt-2" },
        MONTHS.map(item =>
            React__default["default"].createElement(
                RoundedButton,
                {
                ...
                React__default["default"].createElement(
                    ...
                    null,
                    require$$0__default["default"](`2022-${item}-01`).locale(i18n).format("MMM")
                )
            )
        )
    );
...
const Week = () => {
    ...
    return React__default["default"].createElement(
        "div",
        { className: "grid grid-cols-7 border-b border-gray-300 dark:border-gray-700 py-2" },
        DAYS.map(item =>
            React__default["default"].createElement(
                "div",
                { key: item, className: "tracking-wide text-gray-500 text-center" },
                ucFirst(
                    shortString(
                        require$$0__default["default"](`2022-11-${6 + (item + startDateModifier)}`)
                            .locale(i18n)
                            .format("ddd")
                    )
                )
...
const Years = ({ year, currentYear, minYear, maxYear, clickYear }) => {
    const { dateLooking } = React.useContext(DatepickerContext);
    let startDate = 0;
    let endDate = 0;
    switch (dateLooking) {
        case "backward":
...
const Calendar = ({
    ...
    const clickYear = React.useCallback(
        year => {
            setTimeout(() => {
                changeYear(year);
    ...
    const clickDay = React.useCallback(
        (day, month = date.month() + 1, year = date.year()) => {
            ...
            function chosePeriod(start, end) {
                ...
                changeDatepickerValue(
                    {
                        startDate: require$$0__default["default"](start).format(DATE_FORMAT),
                        endDate: require$$0__default["default"](end).format(DATE_FORMAT)
                    },
                    ipt
                );
                hideDatepicker();
            ...
            if ((!period.start && !period.end) || (period.start && period.end)) {
                ...
                if (asSingle) {
                    ...
                    if (maxRange && setSecondMaxDate) {
                        const estimatedMaxDate = require$$0__default["default"](fullDay).add(
                            maxRange,
                            "day"
                        );
                ...
                if (period.start && !period.end) {
                    ...
                    // end null
                    const condition =
                        require$$0__default["default"](fullDay).isSame(
                            require$$0__default["default"](period.start)
                        ) ||
                        require$$0__default["default"](fullDay).isAfter(
                            require$$0__default["default"](period.start)
                        );
                    ...
                    const condition =
                        ...
                        require$$0__default["default"](fullDay).isBefore(
                            require$$0__default["default"](period.end)
                        );
    ...
    const clickNextDays = React.useCallback(
        day => {
    ...
    const minYear = React__default["default"].useMemo(
        () =>
            minDate && require$$0__default["default"](minDate).isValid()
                ? require$$0__default["default"](minDate).year()
                : null,
        [minDate]
    );
    const maxYear = React__default["default"].useMemo(
        () =>
            maxDate && require$$0__default["default"](maxDate).isValid()
                ? require$$0__default["default"](maxDate).year()
                : null,
        [maxDate]
    );
    return React__default["default"].createElement(
        ...
        React__default["default"].createElement(
            ...
            showYears &&
                React__default["default"].createElement(Years, {
                    year: year,
                    minYear: minYear,
                    maxYear: maxYear,
            ...
            !showMonths &&
                ...
                React__default["default"].createElement(
                    ...
                    React__default["default"].createElement(Days, {
            ...
            React__default["default"].createElement(
                PrimaryButton,
                {
                    onClick: () => {
                        if (period.start && period.end) {
                            changeDatepickerValue({
                                startDate: require$$0__default["default"](period.start).format(
                                    DATE_FORMAT
                                ),
                                endDate: require$$0__default["default"](period.end).format(
                                    DATE_FORMAT
                                )
                            });
                            hideDatepicker();
...
const ToggleButton = e => {
    return e.isEmpty
        ? React__default["default"].createElement(DateIcon, { className: "h-5 w-5" })
        : React__default["default"].createElement(CloseIcon, { className: "h-5 w-5" });
};
...
const Input = e => {
    ...
    const handleInputChange = React.useCallback(
        e => {
            ...
            if (dates[0]) {
                ...
                if (dates[1])
                    changeDayHover(
                        require$$0__default["default"](dates[1]).add(-1, "day").format(DATE_FORMAT)
                    );
    ...
    const renderToggleIcon = React.useCallback(
        isEmpty => {
            return typeof toggleIcon === "undefined"
                ? React__default["default"].createElement(ToggleButton, { isEmpty: isEmpty })
                : toggleIcon(isEmpty);
        },
        [toggleIcon]
    );
    ...
    return React__default["default"].createElement(
        ...
        React__default["default"].createElement(
            "button",
            { type: "button", ref: buttonRef, disabled: disabled, className: getToggleClassName() },
...
const Shortcuts = () => {
    ...
    const shortcutOptions = React.useMemo(() => {
        ...
        return Object.entries(configs.shortcuts).flatMap(([key, customConfig]) => {
            ...
            const start = require$$0__default["default"](period.start);
            const end = require$$0__default["default"](period.end);
...
const Datepicker = ({
    ...
    const [firstDate, setFirstDate] = React.useState(
        startFrom && require$$0__default["default"](startFrom).isValid()
            ? require$$0__default["default"](startFrom)
    ...
    const [secondMaxDate, setSecondMaxDate] = React.useState(maxDate);
    // Custom Hooks use
    ...
    /* Start First */
    const firstGotoDate = React.useCallback(
        date => {
    ...
    const changeFirstMonth = React.useCallback(
        month => {
            firstGotoDate(
                require$$0__default["default"](
                    `${firstDate.year()}-${month < 10 ? "0" : ""}${month}-01`
                )
            );
        },
        [firstDate, firstGotoDate]
    );
    const changeFirstYear = React.useCallback(
        year => {
    ...
    /* End First */
    /* Start Second */
    const secondGotoDate = React.useCallback(
        date => {
            const newDate = require$$0__default["default"](formatDate(date, displayFormat));
            const reformatDate = require$$0__default["default"](
                formatDate(firstDate, displayFormat)
            );
    ...
    const changeSecondMonth = React.useCallback(
        month => {
            secondGotoDate(
                require$$0__default["default"](
    ...
    const changeSecondYear = React.useCallback(
        year => {
    ...
    React.useEffect(() => {
        if (startFrom && require$$0__default["default"](startFrom).isValid()) {
            ...
            if (startDate && require$$0__default["default"](startDate).isValid()) {
                setFirstDate(require$$0__default["default"](startDate));
                if (!asSingle) {
                    if (
                        endDate &&
                        require$$0__default["default"](endDate).isValid() &&
                        require$$0__default["default"](endDate)
                            .startOf("month")
                            .isAfter(require$$0__default["default"](startDate))
                    ) {
                        setSecondDate(require$$0__default["default"](endDate));
                    } else {
                        setSecondDate(nextMonth(require$$0__default["default"](startDate)));
                    }
                }
            } else {
...
(function (module, exports) {
    !(function (e, _) {
        module.exports = _(require$$0__default["default"]);
    })(commonjsGlobal, function (e) {
        function _(e) {
            return e && "object" == typeof e && "default" in e ? e : { default: e };
        }
...
(function (module, exports) {
    !(function (e, t) {
        module.exports = t(require$$0__default["default"]);
    })(commonjsGlobal, function (e) {
        function t(e) {
            return e && "object" == typeof e && "default" in e ? e : { default: e };
        }
        var n = t(e),
            r = "يناير_فبراير_مارس_أبريل_مايو_يونيو_يوليو_أغسطس_سبتمبر_أكتوبر_نوفمبر_ديسمبر".split(
                "_"
            ),
...
(function (module, exports) {
    !(function (e, n) {
        module.exports = n(require$$0__default["default"]);
    })(commonjsGlobal, function (e) {
        function n(e) {
            return e && "object" == typeof e && "default" in e ? e : { default: e };
        }
        ...
        function t(e, n, u) {
            return (
                ...
                (function (e, n) {
                    return 2 === n
                        ? (function (e) {
                              return { m: "v", b: "v", d: "z" }[e.charAt(0)] + e.substring(1);
                          })(e)
                        : e;
                })({ mm: "munutenn", MM: "miz", dd: "devezh" }[u], e)
            );
        }
        var o = {
            name: "br",
...
(function (module, exports) {
    !(function (e, s) {
        module.exports = s(require$$0__default["default"]);
    })(commonjsGlobal, function (e) {
        function s(e) {
            return e && "object" == typeof e && "default" in e ? e : { default: e };
        }
...
(function (module, exports) {
    !(function (e, o) {
        module.exports = o(require$$0__default["default"]);
    })(commonjsGlobal, function (e) {
        function o(e) {
            return e && "object" == typeof e && "default" in e ? e : { default: e };
        }
...
(function (module, exports) {
    !(function (e, a) {
        ...
        function u(e, a, t, u) {
            ...
            return a
                ? (s[t][2] ? s[t][2] : s[t][1]).replace("%d", e)
                : (u ? s[t][0] : s[t][1]).replace("%d", e);
        }
        var s = {
            name: "et",
    ...
    !(function (e, n) {
        ...
        var i = n(e),
            t = {
                ...
                monthsShort: "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split(
                    "_"
                ),
                weekStart: 1,
    ...
    !(function (a, e) {
        ...
        var i = e(a),
            n = {
                ...
                monthsShort: "Eaná_Feab_Márt_Aibr_Beal_Méit_Iúil_Lúna_Meán_Deai_Samh_Noll".split(
                    "_"
                ),
    ...
    !(function (a, i) {
        ...
        var n = i(a),
            e = {
                ...
                monthsShort: "Faoi_Gear_Màrt_Gibl_Cèit_Ògmh_Iuch_Lùn_Sult_Dàmh_Samh_Dùbh".split(
                    "_"
                ),
...
(function (module, exports) {
    !(function (Y, M) {
        module.exports = M(require$$0__default["default"]);
...
(function (module, exports) {
    !(function (u, r) {
        module.exports = r(require$$0__default["default"]);
    })(commonjsGlobal, function (u) {
        function r(u) {
            return u && "object" == typeof u && "default" in u ? u : { default: u };
        }
...
(function (module, exports) {
    !(function (e, t) {
        t(exports, require$$0__default["default"]);
...
(function (module, exports) {
    !(function (e, d) {
        module.exports = d(require$$0__default["default"]);
    })(commonjsGlobal, function (e) {
        function d(e) {
            return e && "object" == typeof e && "default" in e ? e : { default: e };
        }
    ...
    !(function (a, e) {
        ...
        var t = e(a),
            u = {
                ...
                monthsShort: "Nzer_Ruhuh_Ntwar_Ndam_Rus_Ruhen_Muk_Myand_Nyak_Git_Muny_Kig".split(
                    "_"
                ),
                weekStart: 1,
                ordinal: function (a) {
    ...
    !(function (e, n) {
        ...
        function s(e, n, t, s) {
            ...
            switch (t) {
                ...
                case "mm":
                    return r(e)
                        ? m + (n || s ? "minuti" : "minutama")
                        : a(e)
                        ? m + (n || s ? "minute" : "minutami")
                        : m + (n || s ? "minut" : "minutami");
                case "h":
                ...
                case "MM":
                    return r(e)
                        ? m + (n || s ? "meseca" : "mesecema")
                        : a(e)
                        ? m + (n || s ? "mesece" : "meseci")
                        : m + (n || s ? "mesecev" : "meseci");
                case "y":
        ...
        var r = t(e),
            a = {
                ...
                relativeTimeFormatter: function (e, t, r, d) {
                    var i = a.words[r];
                    if (1 === r.length)
                        return "y" === r && t ? "једна година" : d || t ? i[0] : i[1];
                    var m = a.correctGrammarCase(e, i);
                    return "yy" === r && t && "%d годину" === m
                        ? e + " година"
                        : m.replace("%d", e);
                }
            },
...
(function (module, exports) {
    !(function (a, j) {
        module.exports = j(require$$0__default["default"]);
    })(commonjsGlobal, function (a) {
        function j(a) {
            return a && "object" == typeof a && "default" in a ? a : { default: a };
        }
