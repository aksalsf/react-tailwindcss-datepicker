...
const Days = ({ calendarData, onClickPreviousDays, onClickDay, onClickNextDays }) => {
    ...
    const isDateTooEarly = React.useCallback((day, type) => {
        ...
        return require$$0__default["default"](formattedDate).isSame(require$$0__default["default"](minDate), "day")
            ? false
    ...
    const isDateTooLate = React.useCallback((day, type) => {
        ...
        const newDate = object[type];
        const formattedDate = newDate.set("date", day);
        return require$$0__default["default"](formattedDate).isSame(require$$0__default["default"](maxDate), "day")
            ? false
    ...
    return (React__default["default"].createElement("div", { className: "grid grid-cols-7 gap-y-0.5 my-1" },
        calendarData.days.previous.map((item, index) => (React__default["default"].createElement("button", { type: "button", key: index, disabled: isDateDisabled(item, "previous"), className: `${buttonClass(item, "previous")}`, onClick: () => handleClickDay(item, "previous"), onMouseOver: () => {
        ...
        calendarData.days.next.map((item, index) => (React__default["default"].createElement("button", { type: "button", key: index, disabled: isDateDisabled(item, "next"), className: `${buttonClass(item, "next")}`, onClick: () => handleClickDay(item, "next"), onMouseOver: () => {
                hoverDay(item, "next");
            } }, item)))));
};
...
const Years = ({ year, currentYear, minYear, maxYear, clickYear }) => {
    ...
    return (React__default["default"].createElement("div", { className: "w-full grid grid-cols-2 gap-2 mt-2" }, generateArrayNumber(startDate, endDate).map((item, index) => (React__default["default"].createElement(RoundedButton, { key: index, padding: "py-3", onClick: () => {
            clickYear(item);
...
const Calendar = ({ date, minDate, maxDate, onClickPrevious, onClickNext, changeMonth, changeYear }) => {
    // Contexts
    const { period, changePeriod, changeDayHover, showFooter, changeDatepickerValue, hideDatepicker, asSingle, i18n, startWeekOn, input, maxRange, setSecondMaxDate } = React.useContext(DatepickerContext);
    loadLanguageModule(i18n);
    // States
    ...
    return (React__default["default"].createElement("div", { className: "w-full md:w-[296px] md:min-w-[296px]" },
        ...
        React__default["default"].createElement("div", { className: "px-0.5 sm:px-2 mt-0.5 min-h-[285px]" },
            showMonths && (React__default["default"].createElement(Months, { currentMonth: calendarData.date.month() + 1, clickMonth: clickMonth })),
            showYears && (React__default["default"].createElement(Years, { year: year, minYear: minYear, maxYear: maxYear, currentYear: calendarData.date.year(), clickYear: clickYear })),
...
const Input = (e) => {
    ...
    const handleInputChange = React.useCallback((e) => {
        ...
        if (dates[0]) {
            ...
            if (dates[1])
                changeDayHover(require$$0__default["default"](dates[1]).add(-1, "day").format(DATE_FORMAT));
            else
            ...
            if (startDate && require$$0__default["default"](startDate).isValid()) {
                ...
                if (!asSingle) {
                    if (endDate &&
                        ...
                        require$$0__default["default"](endDate).startOf("month").isAfter(require$$0__default["default"](startDate))) {
                ...
                React__default["default"].createElement("div", { className: "mt-2.5 shadow-sm border border-gray-300 px-1 py-0.5 bg-white dark:bg-slate-800 dark:text-white dark:border-slate-600 rounded-lg" },
                    React__default["default"].createElement("div", { className: "flex flex-col lg:flex-row py-2" },
                        ...
                        React__default["default"].createElement("div", { className: `flex items-stretch flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-1.5 ${showShortcuts ? "md:pl-2" : "md:pl-1"} pr-2 lg:pr-1` },
                            React__default["default"].createElement(Calendar, { date: firstDate, onClickPrevious: previousMonthFirst, onClickNext: nextMonthFirst, changeMonth: changeFirstMonth, changeYear: changeFirstYear, minDate: minDate, maxDate: secondMaxDate }),
                            useRange && (React__default["default"].createElement(React__default["default"].Fragment, null,
                                ...
                                React__default["default"].createElement(Calendar, { date: secondDate, onClickPrevious: previousMonthSecond, onClickNext: nextMonthSecond, changeMonth: changeSecondMonth, changeYear: changeSecondYear, minDate: minDate, maxDate: secondMaxDate }))))),
...
(function (module, exports) {
	!function(e,t){module.exports=t(require$$0__default["default"]);}(commonjsGlobal,(function(e){function t(e){return e&&"object"==typeof e&&"default"in e?e:{default:e}}var d=t(e),a={name:"da",weekdays:"søndag_mandag_tirsdag_onsdag_torsdag_fredag_lørdag".split("_"),weekdaysShort:"søn._man._tirs._ons._tors._fre._lør.".split("_"),weekdaysMin:"sø._ma._ti._on._to._fr._lø.".split("_"),months:"januar_februar_marts_april_maj_juni_juli_august_september_oktober_november_december".split("_"),monthsShort:"jan._feb._mar._apr._maj_juni_juli_aug._sept._okt._nov._dec.".split("_"),weekStart:1,yearStart:4,ordinal:function(e){return e+"."},formats:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD.MM.YYYY",LL:"D. MMMM YYYY",LLL:"D. MMMM YYYY HH:mm",LLLL:"dddd [d.] D. MMMM YYYY [kl.] HH:mm"},relativeTime:{future:"om %s",past:"%s siden",s:"få sekunder",m:"et minut",mm:"%d minutter",h:"en time",hh:"%d timer",d:"en dag",dd:"%d dage",M:"en måned",MM:"%d måneder",y:"et år",yy:"%d år"}};return d.default.locale(a,null,!0),a})); 
} (da$2, da$2.exports));
...
(function (module, exports) {
	!function(a,e){module.exports=e(require$$0__default["default"]);}(commonjsGlobal,(function(a){function e(a){return a&&"object"==typeof a&&"default"in a?a:{default:a}}var _=e(a),n={name:"uz-latn",weekdays:"Yakshanba_Dushanba_Seshanba_Chorshanba_Payshanba_Juma_Shanba".split("_"),months:"Yanvar_Fevral_Mart_Aprel_May_Iyun_Iyul_Avgust_Sentabr_Oktabr_Noyabr_Dekabr".split("_"),weekStart:1,weekdaysShort:"Yak_Dush_Sesh_Chor_Pay_Jum_Shan".split("_"),monthsShort:"Yan_Fev_Mar_Apr_May_Iyun_Iyul_Avg_Sen_Okt_Noy_Dek".split("_"),weekdaysMin:"Ya_Du_Se_Cho_Pa_Ju_Sha".split("_"),ordinal:function(a){return a},formats:{LT:"HH:mm",LTS:"HH:mm:ss",L:"DD/MM/YYYY",LL:"D MMMM YYYY",LLL:"D MMMM YYYY HH:mm",LLLL:"D MMMM YYYY, dddd HH:mm"},relativeTime:{future:"Yaqin %s ichida",past:"%s oldin",s:"soniya",m:"bir daqiqa",mm:"%d daqiqa",h:"bir soat",hh:"%d soat",d:"bir kun",dd:"%d kun",M:"bir oy",MM:"%d oy",y:"bir yil",yy:"%d yil"}};return _.default.locale(n,null,!0),n})); 
